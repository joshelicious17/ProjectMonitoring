	...
	<section>
		<header>
			<h1>
				...
				<a class="process-guide" href="accesstype-view.do?accessTypeId=${accessType.accessTypeId}">View Access Type</a> > 
				Create Access Type Details
			</h1>
		</header>
			...
			<div class="contents-normal">
				<table width="80%">
					...
					<tr>
						...
						<td width="80%">${accessType.accessTypeId}</td>
					</tr>
					<tr>
						<td>Program Name</td>
						<td>
