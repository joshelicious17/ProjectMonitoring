		...
		<form method="post">
			<div class="contents-normal">
				<table width="80%">
				  ...
				  <tr>
					 <td>User Name</td>
					 <td><input type="text" name="userName" value="${user.userName}" size="8" maxlength="8" placeholder="(1-8 characters)"/>
						<%
				  ...
				  <tr>
					 <td>User Fullname</td>
					 <td><input type="text" name="userFullname" value="${user.userFullname}" size="30" maxlength="30" placeholder="(1-30 characters)"/>
						<%
				  ...
				  <tr>
					 <td>Email Address</td>
					 <td><input type="text" name="userEmail" value="${user.userEmail}" size="30" maxlength="30" placeholder="youremail@address.com"/>
						<%
				  ...
				  <tr>
					 <td>Password</td>
					 <td><input type="password" name="userPassword" value="" size="30" maxlength="30" placeholder="(1-30 characters)"/>
						<%
				  ...
				  <tr>
					 ...
					 <td><input type="password" name="confirmUserPassword" value="" size="30" maxlength="30" placeholder="(1-30 characters)"/>
						<%
