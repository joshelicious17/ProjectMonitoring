		...
		<form method="post">
			<div class="contents-normal">
				<table width="80%">
					...
					<tr>
						<td>Work Name</td>
						<td><input type="text" name="workflowName" value="${workflow.workflowName}" size="30" maxlength="30" />
						<%
					...
					<tr>
						...
						<td>
							...
							<input type="hidden" name="projectName" value="${workflow.projectName}" />
						</td>
					</tr>
					<tr>
						<td>Order</td>
						<td><input type="text" name="workflowSequence" value="${workflow.workflowSequence}" size="5" maxlength="5" />
						<%
