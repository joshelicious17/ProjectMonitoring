		...
		<form method="post">
			<div class="contents-normal">
				<table width="80%">
					...
					<tr>
						<td>Project Name</td>
						<td><input type="text" name="projectName" value="${project.projectName}" size="12" maxlength="12" />
						<%
					...
					<tr>
						...
						<td><input type="text" name="projectDescription" value="${project.projectDescription}" size="60" maxlength="60" />
						<%
					...
					<tr>
						...
						<%
						   if (errors.containsKey("projectStatus")) {
							  out.println("<div class=\"flash error\" id=\"flash_error\">" + errors.get("projectStatus") + "</div>");
						   }
						%>
						</td>
					</tr>			
